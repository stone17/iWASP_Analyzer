...
%for Ek=[0.1E6:.01E6:10E6]
if A==1
    Ek=[0.2E6:.1E6:19.9E6,20E6:1E6:100E6,102.5e6:2.5e6:300e6];    
else
    Ek=[0.2E6:.1E6:19.9E6,20E6:1E6:99E6,100E6:2.5E6:1000E6,1010e6:10e6:2000e6];
end
%trace=zeros(length(Ek),4);
for Ek=Ek
%for Ek=[5E6:1E6:49E6,50E6:10E6:600E6]
%for Ek=[5E8]
