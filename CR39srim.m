...
range_alu_int=interp1(E_alu,range_alu,E_alui);

[index_alu]=find(round(range_alu_int)==alu_thickness); 
E_alu_end=E_alui(index_alu(round(length(index_alu)/2))); %minimum energy that is needed to pass thickness of alu layer
...
range_CR39_int=interp1(E,range,Ei);
